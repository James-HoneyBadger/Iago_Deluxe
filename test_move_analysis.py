...
# Add the Reversi directory to path
sys.path.insert(0, '/home/james/Reversi')
...
def test_move_analysis_toggle():
    ...
    spec = importlib.util.spec_from_file_location("reversi", "/home/james/Reversi/Reversi.py")
